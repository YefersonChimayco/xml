<programas_estudio>
    <disenio_programacion_web>
        ...
        <modulos>
            <modulo1>
                <nombre> ANALISIS Y DISEÑO DE SISTEMAS WEB</nombre>
                <periodos>
                    <p1>
                        <nombre> I</nombre>
                        <unidades_didacticas>
                            ...
                            <ud3>
                                <nombre> INTRODUCCION A BASE DE DATOS</nombre>
                            </ud3>
                            <ud4>
                    ...
                    <p2>
                        ...
                        <unidades_didacticas>
                            ...
                            <ud2>
                                <nombre> Interpretación y producción textos</nombre>
                            </ud2>
                            <ud3>
...
<modulos>
            <modulo1>
                <nombre> Asistencia en promoción y prevención de la salud</nombre>
                <periodos>
                    <p1>
                        <nombre> I</nombre>
                        <unidades_didacticas>
